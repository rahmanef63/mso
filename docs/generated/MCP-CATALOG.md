...
<!-- mcp-toolset: server=1.10.0 version=2026.09.05.1 tools=88 read=44 write=25 exec=19 -->

| Fact | Current source value |
|---|---:|
| MCP server | `1.10.0` |
| Toolset | `2026.09.05.1` |
| Toolset changed at | `2026-09-04T10:25:00Z` |
| Transport tools | **90** |
...
<!-- mcp-chatgpt-profile: server=1.10.0 version=2026.09.05.1 tools=64 read=35 write=17 exec=12 app-only=2 total=66 -->
