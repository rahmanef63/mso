...
<!-- mcp-toolset: server=1.12.3 version=2026.09.09.1 tools=97 read=47 write=30 exec=20 -->

| Fact | Current source value |
|---|---:|
| MCP server | `1.12.3` |
| Toolset | `2026.09.09.1` |
| Toolset changed at | `2026-09-09T05:55:00Z` |
| Transport tools | **99** |
...
<!-- mcp-chatgpt-profile: server=1.12.3 version=2026.09.09.1 tools=71 read=37 write=21 exec=13 app-only=2 total=73 -->
