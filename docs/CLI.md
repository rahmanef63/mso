...
Commands:
 ...
 Host
  ...
  memory-backup *      Local memory snapshot: preview | history | create | verify (memory-backup --help)
  ...
  channels *     Telegram/Discord channels: list, create/save/delete, test, send
