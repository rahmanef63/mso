...
Detailed usage and installation context moved from the main README. For the short overview, see [README](../../README.md).
...
<p align="center">
  ...
  <a href="../media/demo.gif">Watch the demo</a> ·
...
![MSO browser workspace on desktop and mobile](../media/mso-hero.webp)
...
[bootstrap](../../scripts/install.sh) and [installation guide](../INSTALL.md) before executing:
...
not permission to execute a command. See [architecture](../ARCHITECTURE.md) and
...
Full command reference: [docs/CLI.md](../CLI.md) (generated from `mso --help`).
...
and [repeatable assurance process](../SECURITY-ASSURANCE.md) before exposing an instance.
...
Use the strict audit and the [security lanes](../SECURITY-ASSURANCE.md) for release assurance.
...
See [the generated product comparison](../COMPARISON.md).
...
|---|---|
| Install, update, recover | [Installation](../INSTALL.md) · [Troubleshooting](../TROUBLESHOOTING.md) |
| Use the CLI or connect MCP | [Generated CLI reference](../CLI.md) · [MCP](../MCP.md) · [ChatGPT integration](../CHATGPT-PLUGIN.md) |
| Understand the runtime | [Architecture](../ARCHITECTURE.md) · [Cognitive Runtime](../COGNITIVE-RUNTIME.md) |
