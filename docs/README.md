...
| [`WORKFLOW-GRAPH.md`](./WORKFLOW-GRAPH.md) | Private server-native Workflow Graph v2, visual editor, node runtime/logging, dynamic project/folder bindings and automatic learning |
