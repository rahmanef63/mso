...
<!-- mcp-toolset: server=1.7.1 version=2026.09.03.4 tools=72 read=34 write=24 exec=14 -->

Current full transport catalog: **73 tools**, server `1.7.1` / toolset `2026.09.03.4`.
