...
| AI-assisted code audit | OpenAI Codex Security `scan-components` | Ten explicit component scans covering the tracked repository, followed by cross-component root-cause matching | Every component and matching must complete; High/Critical groups fail |
