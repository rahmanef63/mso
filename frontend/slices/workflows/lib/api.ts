...
export type WorkflowOptimizeOptions={mode?:"deterministic"|"jev";threshold?:number;applyReview?:boolean;jev?:{variable?:string;user?:string;connection?:string;tool?:string;model?:string}};
