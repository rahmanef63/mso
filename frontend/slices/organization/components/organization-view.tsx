...
export function OrganizationView() {
  ...
  return (
    <div data-slot="organization-feature" className="@container grid h-full min-h-0 min-w-0 grid-rows-[auto_minmax(0,1fr)] overflow-hidden @min-[700px]:grid-cols-[220px_minmax(0,1fr)] @min-[700px]:grid-rows-1">
      <aside className="min-w-0 border-b bg-card/20 @min-[700px]:flex @min-[700px]:min-h-0 @min-[700px]:flex-col @min-[700px]:border-b-0 @min-[700px]:border-r">
        <div className="flex min-w-0 items-center gap-2 px-3 py-2.5 @min-[700px]:py-3">
        ...
        <div className="px-3 pb-2.5 @min-[700px]:hidden">
        ...
        <nav aria-label="Organization units" className="hidden min-h-0 flex-1 space-y-1 overflow-y-auto px-2 pb-2 @min-[700px]:block">
      ...
      <section className="flex min-h-0 min-w-0 flex-col overflow-hidden">
        <div className="grid min-h-12 shrink-0 grid-cols-[minmax(0,1fr)_auto] items-center gap-2 border-b px-3 py-2">
