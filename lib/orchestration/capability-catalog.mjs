const ROUTES = [
  { id: "automation-flow", priority: 105, patterns: [/\b(automation flow|flow_catalog|flow_run|mso flow|reusable flow|alur otomatis|otomasi provider)\b/i], tools: ["flow_catalog", "flow_run", "flow_status", "flow_manage", "integration_query"], budget: 10_000 },
