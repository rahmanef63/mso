const ROUTES = [
  { id: "automation-flow", priority: 105, patterns: [/\b(automation flow|workflow graph|workflow|flow_catalog|flow_run|mso flow|reusable flow|alur otomatis|otomasi provider|n8n)\b/i], tools: ["workflow_graph_catalog", "workflow_graph_run", "workflow_graph_status", "workflow_graph_manage", "flow_catalog", "flow_run", "flow_status", "flow_manage", "integration_query"], budget: 12_000 },
