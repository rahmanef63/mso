const ROUTES = [
  ...
  { id: "file-read", priority: 70, patterns: [/\b(read|inspect|show|open|cat|baca|lihat|cek|check)\b.*\b(file|readme|config|source|code|berkas|kode)\b/i], tools: ["fs_read"], budget: 10_000 },
  ...
  { id: "read-pipeline", priority: 98, patterns: [/\b(read pipeline|read_pipeline|batch|aggregate|aggregation|filter|projection|bulk read|multiple reads|orchestrat(?:e|ion))\b/i], tools: ["read_pipeline"], budget: 10_000 },
