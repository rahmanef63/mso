...
.integration.manager{--integration-rail:192px;--integration-gap:24px;max-width:1180px;width:100%}
...
.integration .identity-bar{display:flex;gap:10px;align-items:end;flex-wrap:wrap;margin:18px 0}
...
.integration .connection-card{border:0;border-top:1px solid var(--sep);border-radius:0;padding:20px 0;margin:18px 0 0;background:transparent}
...
.integration .identity-actions{display:flex;gap:8px;flex-wrap:wrap;margin-top:16px}.integration .identity-workbench{margin-top:0}.integration .identity-credential-status{display:grid;gap:6px;margin:14px 0;font-size:13px}.integration .identity-credential-status>div{display:grid;grid-template-columns:minmax(0,1fr) auto auto;align-items:center;gap:8px;padding:6px 0;border-bottom:1px solid var(--sep)}.integration .credential-field-state{font-size:12px;color:var(--warning)}.integration .credential-field-state[data-stored=true]{color:var(--success-text)}
...
.integration .identity-empty{border:0;border-top:1px solid var(--sep);border-radius:0;padding:24px 0;margin:20px 0;background:transparent}
...
.integration .identity-summary{display:flex;align-items:center;gap:18px;padding:0 0 18px;margin-bottom:22px;border:0;border-bottom:1px solid var(--sep);border-radius:0;background:transparent}
...
@media(max-width:760px){.surface>.body.integration{margin:0 auto}
.integration.manager{--integration-rail:180px;--integration-gap:16px}.integration .identity-providers{padding-right:12px}.integration .identity-heading{align-items:start}.integration .identity-count{white-space:normal;text-align:right}.integration .identity-summary dl{gap:16px}}
@media(max-width:560px){.integration .owner-picker{max-width:none;flex-basis:100%}.integration .identity-workbench{width:100%}.integration .identity-layout{grid-template-columns:1fr;gap:18px}.integration .identity-providers{grid-template-columns:repeat(2,minmax(0,1fr));max-height:240px;overflow-y:auto;padding:0 0 12px;border:0;border-bottom:1px solid var(--sep)}.integration .identity-providers input{grid-column:1/-1;position:sticky;top:0;background:var(--surface);z-index:1}.integration .identity-providers button{font-size:12px;padding:7px;gap:7px}.integration .identity-fields{grid-template-columns:1fr}.integration .identity-bar{gap:8px;margin:18px 0}.integration .identity-bar>label{max-width:none;flex-basis:100%}.integration .connection-card{padding:16px}.integration .provider-heading{align-items:start;flex-wrap:wrap}.integration .identity-summary{padding:0 0 16px;gap:14px}.integration .identity-summary dl{gap:14px}.integration .identity-summary dd{font-size:17px}.integration .identity-tools[open] .identity-actions{left:0;right:auto}.integration .identity-heading p{font-size:13px}}

.integration .owner-picker{position:relative;min-width:220px;flex:1;max-width:340px}.integration .identity-picker-label{display:block;margin-bottom:6px;font-size:12px;font-weight:650;color:var(--text-dim)}.integration .owner-picker-trigger{display:flex;align-items:center;width:100%;justify-content:space-between;text-align:left;background:var(--field);border-color:var(--sep-strong)}
.integration .owner-picker-popup{position:absolute;z-index:3;top:calc(100% + 6px);left:0;right:0;max-height:240px;overflow:auto;padding:6px;background:var(--surface);border:1px solid var(--sep-strong);border-radius:var(--radius);box-shadow:var(--shadow-pop)}
