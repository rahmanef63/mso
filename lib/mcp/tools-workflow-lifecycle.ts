    ...
    run: async (a, context) => {
      ...
      return {
        ...
        metrics: {
          ...
          recipeRecommended: Boolean(workflow.orchestration?.recipeUsed),
          recipeRouteMatched: finished.reuse?.routeMatched ?? false,
          recipeReuseScore: finished.reuse?.score ?? 0,
