...
export const INTEGRATION_TOOLS:McpTool[]=[
  {name:"integration_query",title:"Inspect Integration Connections",scope:"read",annotations:{readOnlyHint:true,idempotentHint:true,openWorldHint:false},
    ...
    chatgptDescription:"Inspect users, providers and connections. Use view=request for setup or view=resolve before an exact operation.",
  ...
  {name:"integration_manage",title:"Manage Integrations",scope:"write",annotations:{readOnlyHint:false,destructiveHint:true,idempotentHint:false,openWorldHint:true},audit:{action:"infra.write",targetArg:"user"},limit:{key:"integration.manage",max:30,windowMs:60000},
    ...
    chatgptDescription:"Create or update connection metadata with action and confirm=true. Credentials use integration_setup_open.",
  ...
  {name:"integration_execute",title:"Use an Exact Integration Connection",scope:"exec",annotations:{readOnlyHint:false,destructiveHint:true,openWorldHint:true},audit:{action:"infra.write",targetArg:"connection"},limit:{key:"integration.execute",max:30,windowMs:60000},
    ...
    chatgptDescription:"Run an operation for exact user/provider/connection. Route or verify first; mutations need confirm=true.",
