...
export const MSO_PAGE_URI = "ui://mso/page-v14.html";
const MIME = "text/html;profile=mcp-app";

async function pageHtml(): Promise<string> {
  return String.raw`<meta charset="utf-8"><main class="surface" aria-label="MSO Page">
...
<header class="bar">
  ...
  <span class="mode-badge" id="surface-mode" role="status" aria-live="polite">inline</span>
  <div class="tools">
