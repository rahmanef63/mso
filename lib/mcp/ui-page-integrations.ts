...
function renderIntegrations(){
  ...
  const bridge={openTransferBrowser:()=>openIntegrationReference(INTEGRATION_BROWSER+"?transfer=1"),openAiProviders:()=>openIntegrationReference(INTEGRATION_BROWSER+"?section=ai-providers"),remember:s=>integrationSelection=s,openLink:openIntegrationReference,
