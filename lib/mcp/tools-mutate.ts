...
export const MUTATE_TOOLS: McpTool[] = [
  ...
  },
  {
    ...
    description:
      ...
      "Do not use this as the first call: start multi-step work with workflow_start and prefer bounded reads or read_pipeline. " +
    ...
    chatgptDescription: "Last resort shell; prefer reads/read_pipeline first.",
    scope: "exec",
    annotations: { destructiveHint: true, openWorldHint: true },
