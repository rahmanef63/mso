...
export const INFRA_TOOLS: McpTool[] = [
  {
    ...
    description: "List MSO infrastructure providers (Dokploy, Cloudflare, Hostinger), showing masked configuration state and missing required fields. Raw credentials are never returned.",
    scope: "read",
